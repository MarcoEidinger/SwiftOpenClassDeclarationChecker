...
/// Swift type representating an AST element (analogue to SourceKitten's Structure)
internal struct SyntaxStructure: Codable {
    internal init(accessibility: ElementAccessibility?, attribute: String?, attributes: [SyntaxStructure]?, inheritedTypes: [SyntaxStructure]?, kind: ElementKind?, name: String?, substructure: [SyntaxStructure]?) {
